...
function UseMemoUserSearch() {
  ...
  return (
    ...
    >
      <h3 style={{ margin: "0 0 12px", textAlign: "center" }}>useMemo + Custom Hook Search Users</h3>
      ...
      {!loading && error.error && <div style={{ color: "#dc2626" }}>Loi: {error.message}</div>}
          ...
          {filteredUsers.map((user) => (
            ...
            >
              <div>
                ...
                <div style={{ fontSize: "13px", color: "#6b7280" }}>@{user.username}</div>
              </div>
...
export default UseMemoUserSearch;